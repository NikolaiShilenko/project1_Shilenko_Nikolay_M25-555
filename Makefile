...
# Проверка кода на соответствие стандартам PEP8 и выявление ошибок.
# Запускает линтер Ruff для анализа всего кода в проекте.
# Показывает ошибки форматирования, синтаксические ошибки и предупреждения.
# Использует настройки из секций [tool.ruff] и [tool.ruff.lint] в pyproject.toml.
lint:
